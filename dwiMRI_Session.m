classdef dwiMRI_Session  < dynamicprops & matlab.mixin.SetGet
    ...
    methods
        ...
        function obj = setDefaultParams(obj)
            ...
            obj.Trkland.hippocing.data.done = 0; 
            obj.Trkland.cingulum.data.done = 0; 
        ...
        function obj = trkland_fx(obj)
            ...
            for tohide=1:1
                ...
                %INIT OUTPUTS
                obj.Trkland.fx.out.trimmedclean_lh = [ obj.Trkland.root  'trkk_fx_trimmedclean_lh.trk.gz'];
                obj.Trkland.fx.out.trimmedclean_rh = [ obj.Trkland.root  'trkk_fx_trimmedclean_rh.trk.gz'];
                
                obj.Trkland.fx.out.trimmedclean_interp_lh = [  obj.Trkland.root  'trkk_fx_trimmedclean_interp_lh.trk.gz' ];
                obj.Trkland.fx.out.trimmedclean_interp_rh = [  obj.Trkland.root  'trkk_fx_trimmedclean_interp_rh.trk.gz'];
                ...
                obj.Trkland.fx.out.clineFA_lh_highFA = [ obj.Trkland.root  'trkk_fx_cline_highFA_lh.trk.gz'];
                obj.Trkland.fx.out.clineFA_lh_HDorff = [ obj.Trkland.root  'trkk_fx_cline_HDorff_lh.trk.gz'];
                
                obj.Trkland.fx.out.clineFA_rh_highFA = [ obj.Trkland.root  'trkk_fx_cline_highFA_rh.trk.gz'];
                obj.Trkland.fx.out.clineFA_rh_HDorff = [ obj.Trkland.root  'trkk_fx_cline_HDorff_rh.trk.gz'];
                
                
                obj.Trkland.fx.QCfile_lh = [outpath 'QC_fx_lh.flag'] ;
                obj.Trkland.fx.QCfile_rh = [outpath 'QC_fx_rh.flag'] ;
                obj.Trkland.fx.QCfile_bil = [outpath 'QC_fx_bil.flag'] ;
            end
...
%                     RefreshFields(obj,'fx','bil')
            ...
            for tohide=1:1
                ...
                for tohide=1:1
                    ...
                    if  exist(obj.Trkland.fx.out.trimmedclean_lh,'file' ) ~= 0 
                        ...
                        obj.Trkland.Trks.fx_trimmedclean_interp_lh.sstr = [];
                        obj.Trkland.Trks.fx_trimmedclean_interp_lh.header = [];
                    end
                    ...
                    if exist(obj.Trkland.fx.out.trimmedclean_interp_lh,'file') ~= 0
                        if exist(obj.Trkland.fx.out.clineFA_lh_highFA,'file')==0
                            ...
                            temp_clean_trk_lh = rotrk_read(obj.Trkland.fx.out.trimmedclean_interp_lh,obj.sessionname,obj.Params.Dtifit.out.FA{end},'fx_lh_trimmedclean_interp');
                        ...
                        obj.Trkland.Trks.fx_clinehighFA_lh.header = [] ;
                    end
                    ...
                    if exist(obj.Trkland.fx.out.trimmedclean_interp_lh,'file') ~= 0
                        ...
                        obj.Trkland.Trks.fx_clineHDorff_lh.header = [] ;
                    end
                end
                ...
                for tohide=1:1
                    ...
                    if  exist(obj.Trkland.fx.out.trimmedclean_rh,'file' ) ~= 0
                        ...
                        obj.Trkland.Trks.fx_trimmedclean_interp_rh.sstr = [];
                        obj.Trkland.Trks.fx_trimmedclean_interp_rh.header = [];
                    end
                    ...
                    if exist(obj.Trkland.fx.out.trimmedclean_interp_rh,'file') ~= 0
                        ...
                        obj.Trkland.Trks.fx_clinehighFA_rh.header = [] ;
                    end
                    %HDorff centerline:
                    if exist(obj.Trkland.fx.out.trimmedclean_interp_rh,'file') ~= 0
        ...
        function obj = trkland_hippocing(obj)
            ...
            for tohide=1:1
                ...
                obj.Trkland.hippocing.out.trimmedclean_interp_lh = [ obj.Trkland.root  'trkk_hippocing_trimmedclean_interp_lh.trk.gz'];
                obj.Trkland.hippocing.out.trimmedclean_interp_rh = [ obj.Trkland.root  'trkk_hippocing_trimmedclean_interp_rh.trk.gz'];
                ...
                obj.Trkland.hippocing.out.clineFA_lh_highFA = [ obj.Trkland.root  'trkk_hippocing_cline_highFA_lh.trk.gz'];
                obj.Trkland.hippocing.out.clineFA_lh_HDorff = [ obj.Trkland.root  'trkk_hippocing_cline_HDorff_lh.trk.gz'];
                obj.Trkland.hippocing.out.clineFA_rh_highFA = [ obj.Trkland.root  'trkk_hippocing_cline_highFA_rh.trk.gz'];
                obj.Trkland.hippocing.out.clineFA_rh_HDorff = [ obj.Trkland.root  'trkk_hippocing_cline_HDorff_rh.trk.gz'];
            ...
            for tohide=1:1
                ...
                if  exist(obj.Trkland.hippocing.out.trimmedclean_lh,'file' ) ~= 0
                    ...
                    obj.Trkland.Trks.hippocing_trimmedclean_interp_lh.sstr = [];
                    obj.Trkland.Trks.hippocing_trimmedclean_interp_lh.header = [];
                end
                ...
                if exist(obj.Trkland.hippocing.out.trimmedclean_interp_lh,'file') ~=0 
                    ...
                    obj.Trkland.Trks.hippocing_clinehighFA_lh.header = [] ;
                end
                %HDorff_centerline:
                if exist(obj.Trkland.hippocing.out.trimmedclean_interp_lh,'file') ~=0 
                    ...
                    obj.Trkland.Trks.hippocing_clineHDorff_lh.header = [] ;
                end
            end
            ...
            for tohide=1:1
                ...
                if  exist(obj.Trkland.hippocing.out.trimmedclean_rh,'file' ) ~= 0
                    ...
                    obj.Trkland.Trks.hippocing_trimmedclean_interp_rh.sstr = [];
                    obj.Trkland.Trks.hippocing_trimmedclean_interp_rh.header = [];
                end
                ...
                if  exist(obj.Trkland.hippocing.out.trimmedclean_interp_rh,'file') ~= 0
                    ...
                    obj.Trkland.Trks.hippocing_clinehighFA_rh.header = [] ;
                end
                %Hdorff
                if exist(obj.Trkland.hippocing.out.trimmedclean_interp_rh,'file') ~= 0
                    ...
                    obj.Trkland.Trks.hippocing_clineHDorff_rh.header = [] ;
                end
            ...
            %NOW GETTING THE DATA VALUES:
            if  obj.Trkland.hippocing.data.done ~= 1
            %Get data for all interesting values:
            data_trks= fields(obj.Trkland.hippocing.out);
            for ii=1:numel(data_trks)
                if exist(obj.Trkland.hippocing.out.(data_trks{ii}),'file') ~= 0
                    fprintf(['\ntrkland_hippocing(): Getting hippocing_data for ' data_trks{ii} '...'] ) ;
                    %Reading and adding scalars:
                    temp_read = rotrk_read(obj.Trkland.hippocing.out.(data_trks{ii}),'no_warning',obj.Params.Dtifit.out.FA{end});
                    temp_read = rotrk_add_sc(temp_read ,obj.Params.Dtifit.out.FA{end} , 'FA');
                    temp_read = rotrk_add_sc(temp_read ,strrep(obj.Params.Dtifit.out.FA{end},'FA','RD') , 'RD');
                    temp_read = rotrk_add_sc(temp_read ,strrep(obj.Params.Dtifit.out.FA{end},'FA','AxD') , 'AxD');
                    temp_read = rotrk_add_sc(temp_read ,strrep(obj.Params.Dtifit.out.FA{end},'FA','MD') , 'MD');
                    ...
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_vol' ])  = temp_read.num_uvox;
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_FA' ]) = mean(temp_read.unique_voxels(:,4));
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_RD' ]) = mean(temp_read.unique_voxels(:,5));
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_AxD' ]) = mean(temp_read.unique_voxels(:,6));
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_MD' ] ) = mean(temp_read.unique_voxels(:,7));
                    fprintf('done\n');
                else
                    fprintf(['\ntrkland_hippocing():  No filename found for ' data_trks{ii} '...'] ) ;
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_vol' ]) = [];
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_FA' ]) = [];
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_RD' ]) = [];
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_AxD' ]) = [];
                    obj.Trkland.hippocing.data.([ (data_trks{ii}) '_MD' ] ) = [];
                end
            end
            clear data_trks;
            obj.Trkland.hippocing.data.done = 1; 
            end
        end
        ...
        function obj = trkland_cingulum(obj)
            ...
            for tohide=1:1
                obj.Trkland.cingulum.out.trimmedclean_lh = [ obj.Trkland.root  'trkk_cingulum_trimmedclean_lh.trk.gz'];
                obj.Trkland.cingulum.out.trimmedclean_rh = [ obj.Trkland.root  'trkk_cingulum_trimmedclean_rh.trk.gz'];
                
                obj.Trkland.cingulum.out.trimmedclean_interp_lh = [ obj.Trkland.root  'trkk_cingulum_trimmedclean_interp_lh.trk.gz'];
                obj.Trkland.cingulum.out.trimmedclean_interp_rh = [ obj.Trkland.root  'trkk_cingulum_trimmedclean_interp_rh.trk.gz'];
                ...
                obj.Trkland.cingulum.out.clineFA_lh_highFA = [ obj.Trkland.root  'trkk_cingulum_cline_highFA_lh.trk.gz'];
                obj.Trkland.cingulum.out.clineFA_lh_HDorff = [ obj.Trkland.root  'trkk_cingulum_cline_HDorff_lh.trk.gz'];
                obj.Trkland.cingulum.out.clineFA_rh_highFA = [ obj.Trkland.root  'trkk_cingulum_cline_highFA_rh.trk.gz'];
                obj.Trkland.cingulum.out.clineFA_rh_HDorff = [ obj.Trkland.root  'trkk_cingulum_cline_HDorff_rh.trk.gz'];
            ...
            for tohide=1:1
                ...
                if exist(obj.Trkland.cingulum.out.trimmedclean_lh,'file') ~= 0 
                    ...
                    obj.Trkland.Trks.cingulum_trimmedclean_interp_lh.sstr = [];
                    obj.Trkland.Trks.cingulum_trimmedclean_interp_lh.header = [];
                end
                ...
                if exist(obj.Trkland.cingulum.out.trimmedclean_interp_lh,'file') ~= 0
                    ...
                    obj.Trkland.Trks.cingulum_clinehighFA_lh.header = [] ;
                end
                %centerline_HDorff:
                if exist(obj.Trkland.cingulum.out.trimmedclean_interp_lh,'file') ~= 0
                    ...
                    obj.Trkland.Trks.cingulum_clineHDorff_lh.header = [] ;
                end
            end
            ...
            for tohide=1:1
                ...
                if exist(obj.Trkland.cingulum.out.trimmedclean_rh,'file') ~= 0
                    ...
                    obj.Trkland.Trks.cingulum_trimmedclean_interp_rh.sstr = [];
                    obj.Trkland.Trks.cingulum_trimmedclean_interp_rh.header = [];
                end
                ...
                if exist(obj.Trkland.cingulum.out.trimmedclean_interp_rh,'file') ~= 0
                    ...
                    obj.Trkland.Trks.cingulum_clinehighFA_rh.header = [] ;                    
                end
                %HDorff_centerline:
                if exist(obj.Trkland.cingulum.out.trimmedclean_interp_rh,'file') ~= 0
                    ...
                    obj.Trkland.Trks.cingulum_clineHDorff_rh.header = [] ;                    
                end
            end
             
            %NOW GETTING THE DATA VALUES:
            if  obj.Trkland.cingulum.data.done ~= 1
                %Get data for all interesting values:
                data_trks= fields(obj.Trkland.cingulum.out);
                for ii=1:numel(data_trks)
                    if exist(obj.Trkland.cingulum.out.(data_trks{ii}),'file') ~= 0
                        fprintf(['\ntrkland_cingulum(): Getting cingulum_data for ' data_trks{ii} '...'] ) ;
                        %Reading and adding scalars:
                        temp_read = rotrk_read(obj.Trkland.cingulum.out.(data_trks{ii}),'no_warning',obj.Params.Dtifit.out.FA{end});
                        temp_read = rotrk_add_sc(temp_read ,obj.Params.Dtifit.out.FA{end} , 'FA');
                        temp_read = rotrk_add_sc(temp_read ,strrep(obj.Params.Dtifit.out.FA{end},'FA','RD') , 'RD');
                        temp_read = rotrk_add_sc(temp_read ,strrep(obj.Params.Dtifit.out.FA{end},'FA','AxD') , 'AxD');
                        temp_read = rotrk_add_sc(temp_read ,strrep(obj.Params.Dtifit.out.FA{end},'FA','MD') , 'MD');
                        ...
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_vol' ])  = temp_read.num_uvox;
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_FA' ]) = mean(temp_read.unique_voxels(:,4));
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_RD' ]) = mean(temp_read.unique_voxels(:,5));
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_AxD' ]) = mean(temp_read.unique_voxels(:,6));
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_MD' ] ) = mean(temp_read.unique_voxels(:,7));
                        fprintf('done\n');
                    else
                        fprintf(['\ntrkland_cingulumg():  No filename found for ' data_trks{ii} '...'] ) ;
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_vol' ]) = [];
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_FA' ]) = [];
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_RD' ]) = [];
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_AxD' ]) = [];
                        obj.Trkland.cingulum.data.([ (data_trks{ii}) '_MD' ] ) = [];
                    end
                end
                obj.Trkland.cingulum.data.done = 1 ;
                clear data_trks;
            end
...
%                         %Clean up based on normality of hausdorff distance:
%                         obj.Trkland.Trks.atr_trimmedclean_lh = rotrk_rm_byHDorff(obj.Trkland.Trks.atr_clineinit_lh, obj.Trkland.Trks.atr_trimmed_lh,obj.Trkland.Trks.atr_trimmed_lh);
%                         %%%obj.Trkland.Trks.atr_trimmedclean_lh = rotrk_rm_bylen(temp_fx_lh_cline, temp_fx_lh,temp_fx_lh);
%                         %Now that the TRK is clean, lets get the high_FA and get the centerline:
%                         %Pick centerline based on high_sc and FA:
%                         obj.Trkland.Trks.atr_clinehighFA_lh= rotrk_centerline(obj.Trkland.Trks.atr_trimmedclean_lh, 'high_sc','FA');
%                         obj.Trkland.Trks.atr_clineHDorff_lh = rotrk_centerline(obj.Trkland.Trks.atr_trimmedclean_lh, 'hausdorff');
%                         %save trks:
...
%                         rotrk_write(obj.Trkland.Trks.atr_trimmedclean_lh.header,obj.Trkland.Trks.atr_trimmedclean_lh.sstr,obj.Trkland.atr.out.clean_trks_lh );
...
%                         obj.Trkland.atr.data.lh_trimmedclean_vol = obj.Trkland.Trks.atr_trimmedclean_lh.num_uvox;
...
%                         %Clean_atr:
%                         obj.Trkland.atr.data.lh_trimmedclean_FA = mean(obj.Trkland.Trks.atr_trimmedclean_lh.unique_voxels(:,4));
%                         obj.Trkland.atr.data.lh_trimmedclean_RD = mean(obj.Trkland.Trks.atr_trimmedclean_lh.unique_voxels(:,5));
%                         obj.Trkland.atr.data.lh_trimmedclean_AxD = mean(obj.Trkland.Trks.atr_trimmedclean_lh.unique_voxels(:,6));
%                         obj.Trkland.atr.data.lh_trimmedclean_MD = mean(obj.Trkland.Trks.atr_trimmedclean_lh.unique_voxels(:,7));
%                         %Trimmed_clean_atr:
...
%                     try
%                         clear obj.Trkland.Trks.raw_atr_rh obj.Trkland.Trks.atr_trimmedclean_rh obj.Trkland.Trks.atr_clineinit_rh
...
%                         %Clean up based on normality of hausdorff distance
%                         obj.Trkland.Trks.atr_trimmedclean_rh = rotrk_rm_byHDorff(obj.Trkland.Trks.atr_clineinit_rh, obj.Trkland.Trks.atr_trimmed_rh,obj.Trkland.Trks.atr_trimmed_rh);
%                         %%%%obj.Trkland.Trks.atr_trimmedclean_rh = rotrk_rm_bylen(temp_fx_rh_cline, temp_fx_rh,temp_fx_rh);
%                         %Now that the TRK is clean, lets get the high_FA and get the centerline:
%                         %Pick centerline based on high_sc and FA:
%                         obj.Trkland.Trks.atr_clinehighFA_rh= rotrk_centerline(obj.Trkland.Trks.atr_trimmedclean_rh, 'high_sc','FA');
%                         obj.Trkland.Trks.atr_clineHDorff_rh = rotrk_centerline(obj.Trkland.Trks.atr_trimmedclean_rh, 'hausdorff');
%                         %save trks:
%                         rotrk_write(obj.Trkland.Trks.atr_trimmedclean_rh.header,obj.Trkland.Trks.atr_trimmedclean_rh.sstr,obj.Trkland.atr.out.clean_trks_rh )
...
%                         obj.Trkland.atr.data.rh_clean_vol = obj.Trkland.Trks.atr_trimmedclean_rh.num_uvox;
...
%                         %Clean_atr:
%                         obj.Trkland.atr.data.rh_clean_FA = mean(obj.Trkland.Trks.atr_trimmedclean_rh.unique_voxels(:,4));
%                         obj.Trkland.atr.data.rh_clean_RD = mean(obj.Trkland.Trks.atr_trimmedclean_rh.unique_voxels(:,5));
%                         obj.Trkland.atr.data.rh_clean_AxD = mean(obj.Trkland.Trks.atr_trimmedclean_rh.unique_voxels(:,6));
%                         obj.Trkland.atr.data.rh_clean_MD = mean(obj.Trkland.Trks.atr_trimmedclean_rh.unique_voxels(:,7));
%                         %Trimmed_clean_atr:
...
%             end
        ...
        %not finished methods (probably able to remove then):
        function obj = getdata_trkland_fx(obj)
            temp=1;
            if temp == 1 ;
                display('Not finished. Missing interp data here...');
            else
                %Get volume data of unclean/cleaned tracts:
                %Volume:
                obj.Trkland.fx.data.lh_unclean_vol = obj.Trkland.Trks.fx_raw_lh.num_uvox;
                obj.Trkland.fx.data.lh_trimmedclean_vol = obj.Trkland.Trks.fx_trimmedclean_lh.num_uvox;
                ...
                %Clean_fx:
                obj.Trkland.fx.data.lh_trimmedclean_FA = mean(obj.Trkland.Trks.fx_trimmedclean_lh.unique_voxels(:,4));
                obj.Trkland.fx.data.lh_trimmedclean_RD = mean(obj.Trkland.Trks.fx_trimmedclean_lh.unique_voxels(:,5));
                obj.Trkland.fx.data.lh_trimmedclean_AxD = mean(obj.Trkland.Trks.fx_trimmedclean_lh.unique_voxels(:,6));
                obj.Trkland.fx.data.lh_trimmedclean_MD = mean(obj.Trkland.Trks.fx_trimmedclean_lh.unique_voxels(:,7));
                %Cline_HighFA
                if ~isfield(obj.Trkland.Trks.fx_clinehighFA_lh,'maxsstrlen')
                    obj.Trkland.Trks.fx_clinehighFA_lh = rotrk_centerline(obj.Trkland.Trks.fx_trimmedclean_lh, 'high_sc','FA');
                end
                ...
                if ~isfield(obj.Trkland.Trks.fx_clineHDorff_lh,'maxsstrlen')
                    obj.Trkland.Trks.fx_clineHDorff_lh = rotrk_centerline(obj.Trkland.Trks.fx_trimmedclean_lh, 'hausdorff');
                end
                ...
                obj.Trkland.fx.data.rh_clean_vol = obj.Trkland.Trks.fx_trimmedclean_rh.num_uvox;
                ...
                %Clean_fx:
                obj.Trkland.fx.data.rh_clean_FA = mean(obj.Trkland.Trks.fx_trimmedclean_rh.unique_voxels(:,4));
                obj.Trkland.fx.data.rh_clean_RD = mean(obj.Trkland.Trks.fx_trimmedclean_rh.unique_voxels(:,5));
                obj.Trkland.fx.data.rh_clean_AxD = mean(obj.Trkland.Trks.fx_trimmedclean_rh.unique_voxels(:,6));
                obj.Trkland.fx.data.rh_clean_MD = mean(obj.Trkland.Trks.fx_trimmedclean_rh.unique_voxels(:,7));
                %Cline_HighFA
                if ~isfield(obj.Trkland.Trks.fx_clinehighFA_rh,'maxsstrlen')
                    obj.Trkland.Trks.fx_clinehighFA_rh = rotrk_centerline(obj.Trkland.Trks.fx_trimmedclean_rh, 'high_sc','FA');
                end
                ...
                if ~isfield(obj.Trkland.Trks.fx_clineHDorff_rh,'maxsstrlen')
                    obj.Trkland.Trks.fx_clineHDorff_rh = rotrk_centerline(obj.Trkland.Trks.fx_trimmedclean_rh, 'hausdorff');
                end
        ...
        function obj = getdata_trkland_hippocing(obj)
            ...
            if temp == 1 ;
                ...
                %Clean_hippocing:
                obj.Trkland.hippocing.data.lh_trimmedclean_FA = mean(obj.Trkland.Trks.hippocing_trimmedclean_lh.unique_voxels(:,4));
                obj.Trkland.hippocing.data.lh_trimmedclean_RD = mean(obj.Trkland.Trks.hippocing_trimmedclean_lh.unique_voxels(:,5));
                obj.Trkland.hippocing.data.lh_trimmedclean_AxD = mean(obj.Trkland.Trks.hippocing_trimmedclean_lh.unique_voxels(:,6));
                obj.Trkland.hippocing.data.lh_trimmedclean_MD = mean(obj.Trkland.Trks.hippocing_trimmedclean_lh.unique_voxels(:,7));
                %Trimmed_clean_hippocing:
                ...
                if ~isfield(obj.Trkland.Trks.hippocing_clinehighFA_lh,'maxsstrlen')
                    obj.Trkland.Trks.hippocing_clinehighFA_lh= rotrk_centerline(obj.Trkland.Trks.hippocing_trimmedclean_lh, 'high_sc','FA');
                end
                ...
                if ~isfield(obj.Trkland.Trks.hippocing_clineHDorff_lh,'maxsstrlen')
                    obj.Trkland.Trks.hippocing_clineHDorff_lh = rotrk_centerline(obj.Trkland.Trks.hippocing_trimmedclean_lh, 'hausdorff');
                end
                ...
                obj.Trkland.hippocing.data.rh_trimmedclean_vol = obj.Trkland.Trks.hippocing_trimmedclean_rh.num_uvox;
                ...
                %Clean_hippocing:
                obj.Trkland.hippocing.data.rh_trimmedclean_FA = mean(obj.Trkland.Trks.hippocing_trimmedclean_rh.unique_voxels(:,4));
                obj.Trkland.hippocing.data.rh_trimmedclean_RD = mean(obj.Trkland.Trks.hippocing_trimmedclean_rh.unique_voxels(:,5));
                obj.Trkland.hippocing.data.rh_trimmedclean_AxD = mean(obj.Trkland.Trks.hippocing_trimmedclean_rh.unique_voxels(:,6));
                obj.Trkland.hippocing.data.rh_trimmedclean_MD = mean(obj.Trkland.Trks.hippocing_trimmedclean_rh.unique_voxels(:,7));
                %Trimmed_clean_hippocing:
                ...
                if ~isfield(obj.Trkland.Trks.hippocing_clinehighFA_rh,'maxsstrlen')
                    obj.Trkland.Trks.hippocing_clinehighFA_rh= rotrk_centerline(obj.Trkland.Trks.hippocing_trimmedclean_rh, 'high_sc','FA');
                end
                ...
                if ~isfield(obj.Trkland.Trks.hippocing_clineHDorff_rh,'maxsstrlen')
                    obj.Trkland.Trks.hippocing_clineHDorff_rh = rotrk_centerline(obj.Trkland.Trks.hippocing_trimmedclean_rh, 'hausdorff');
                end
        ...
        function obj = getdata_trkland_cingulum(obj)
            ...
            if temp == 1 ;
                ...
                obj.Trkland.cingulum.data.lh_trimmedclean_vol = obj.Trkland.Trks.cingulum_trimmedclean_lh.num_uvox;
                ...
                %Clean_cingulum:
                obj.Trkland.cingulum.data.lh_trimmedclean_FA = mean(obj.Trkland.Trks.cingulum_trimmedclean_lh.unique_voxels(:,4));
                obj.Trkland.cingulum.data.lh_trimmedclean_RD = mean(obj.Trkland.Trks.cingulum_trimmedclean_lh.unique_voxels(:,5));
                obj.Trkland.cingulum.data.lh_trimmedclean_AxD = mean(obj.Trkland.Trks.cingulum_trimmedclean_lh.unique_voxels(:,6));
                obj.Trkland.cingulum.data.lh_trimmedclean_MD = mean(obj.Trkland.Trks.cingulum_trimmedclean_lh.unique_voxels(:,7));
                ...
                if ~isfield(obj.Trkland.Trks.cingulum_clinehighFA_lh,'maxsstrlen')
                    obj.Trkland.Trks.cingulum_clinehighFA_lh= rotrk_centerline(obj.Trkland.Trks.cingulum_trimmedclean_lh, 'high_sc','FA');
                end
                ...
                if ~isfield(obj.Trkland.Trks.cingulum_clineHDorff_lh,'maxsstrlen')
                    obj.Trkland.Trks.cingulum_clineHDorff_lh = rotrk_centerline(obj.Trkland.Trks.cingulum_trimmedclean_lh, 'hausdorff');
                end
                ...
                obj.Trkland.cingulum.data.rh_trimmedclean_vol = obj.Trkland.Trks.cingulum_trimmedclean_rh.num_uvox;
                ...
                %Clean_cingulum:
                obj.Trkland.cingulum.data.rh_trimmedclean_FA = mean(obj.Trkland.Trks.cingulum_trimmedclean_rh.unique_voxels(:,4));
                obj.Trkland.cingulum.data.rh_trimmedclean_RD = mean(obj.Trkland.Trks.cingulum_trimmedclean_rh.unique_voxels(:,5));
                obj.Trkland.cingulum.data.rh_trimmedclean_AxD = mean(obj.Trkland.Trks.cingulum_trimmedclean_rh.unique_voxels(:,6));
                obj.Trkland.cingulum.data.rh_trimmedclean_MD = mean(obj.Trkland.Trks.cingulum_trimmedclean_rh.unique_voxels(:,7));
                %Trimmed_clean_cingulum:
                ...
                if ~isfield(obj.Trkland.Trks.cingulum_clinehighFA_rh,'maxsstrlen')
                    obj.Trkland.Trks.cingulum_clinehighFA_rh= rotrk_centerline(obj.Trkland.Trks.cingulum_trimmedclean_rh, 'high_sc','FA');
                end
                ...
                if ~isfield(obj.Trkland.Trks.cingulum_clineHDorff_rh,'maxsstrlen')
                    obj.Trkland.Trks.cingulum_clineHDorff_rh = rotrk_centerline(obj.Trkland.Trks.cingulum_trimmedclean_rh, 'hausdorff');
                end
